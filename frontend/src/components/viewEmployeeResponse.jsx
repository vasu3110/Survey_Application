...
const ViewEmployeeResponse = () => {
  ...
  //   throw new Error(
  //     "Survey questions must be loaded before using ViewEmployeeResponse component"
  //   );
  // }
          ...
          <div className="mb-6 p-4 bg-blue-50 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <p>
                ...
                {formTypes.find((f) => f.id === submission.formType)?.formType}
              </p>
              <p>
...
export default ViewEmployeeResponse;
